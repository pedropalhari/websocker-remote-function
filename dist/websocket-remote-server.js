...
var WS = require("ws");
function initializeWS(functionObject, port) {
    ...
    wss.on("connection", function connection(ws) {
        ...
        ws.on("message", function incoming(message) {
            return __awaiter(this, void 0, void 0, function () {
                var wsObject, func, data, response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            wsObject = JSON.parse(message);
                            func = wsObject.func, data = wsObject.data;
                            return [4 /*yield*/, functionObject[func](data)];
                        case 1:
                            response = _a.sent();
                            ws.send(JSON.stringify({
